...
class AdminAboutSections1Controller extends CBController
{
    ...
    public function cbInit()
    {
        ...
        # END CONFIGURATION DO NOT REMOVE THIS LINE
			...
			$this->col[] = ["label"=>"Content","name"=>"content","str_limit"=>"150"];
			$this->col[] = ["label"=>"Image","name"=>"image","image"=>true];
			$this->col[] = ["label"=>"Profile","name"=>"profile","download"=>true];
			...
			$this->form[] = ['label'=>'Profile','name'=>'profile','type'=>'filemanager','width'=>'col-sm-9','filemanager_type'=>'file'];
			...
			//$this->form[] = ['label'=>'Content','name'=>'content','type'=>'textarea','validation'=>'required|string','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Image','name'=>'image','type'=>'filemanager','validation'=>'required','width'=>'col-sm-10','filemanager_type'=>'image'];
			//$this->form[] = ['label'=>'Profile','name'=>'profile','type'=>'filemanager','width'=>'col-sm-9','filemanager_type'=>'image'];
			# OLD END FORM

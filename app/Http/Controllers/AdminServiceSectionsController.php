...
class AdminServiceSectionsController extends CBController {
	...
	public function cbInit() {
			...
			// $this->col[] = ["label"=>"Content","name"=>"content","str_limit"=>"100"];
            ...
            $this->form[] = ['label'=>'Price','name'=>'price','type'=>'text','validation'=>'required|string','width'=>'col-sm-10','placeholder'=>''];
			// $this->form[] = ['label'=>'Content','name'=>'content','type'=>'textarea','validation'=>'','width'=>'col-sm-10'];

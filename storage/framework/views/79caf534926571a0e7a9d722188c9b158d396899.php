    ...
    <div style="width:750px;margin:0 auto ">
        <?php if(CRUDBooster::isSuperAdmin()): ?>
            <p align="right"><a title='Add Field Setting' class='btn btn-sm btn-primary'
                    href='<?php echo e(route('SettingsControllerGetAdd') . '?group_setting=' . $page_title); ?>'><i
                        class='fa fa-plus'></i>
                    Add Field Setting</a></p>
        <?php endif; ?>
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class='fa fa-cog'></i> <?php echo e(cbLang($page_title)); ?>

            </div>
            <div class="panel-body">
                <form method='post' id="form" enctype="multipart/form-data"
                    action='<?php echo e(CRUDBooster::mainpath("save-setting?group_setting=$page_title")); ?>'>
                    ...
                    <div class="box-body">
                        ...
                        <div class='form-group'>
                            <label class='label-setting' title="<?php echo e($s->name); ?>"><?php echo e(cbLang($s->label)); ?>

                                <?php if(CRUDBooster::isSuperAdmin()): ?>
                                    <a style="visibility:hidden" href='<?php echo e(CRUDBooster::mainpath("edit/$s->id")); ?>'
                            ...
                            <div class='help-block'><?php echo e(cbLang($s->helper)); ?></div>
                        </div>
                        <?php endforeach;?>
                    </div><!-- /.box-body -->
...
<?php echo $__env->make('crudbooster::admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BMSK\BMSK\vendor\voila_cms\crudbooster\src/views/setting.blade.php ENDPATH**/ ?>
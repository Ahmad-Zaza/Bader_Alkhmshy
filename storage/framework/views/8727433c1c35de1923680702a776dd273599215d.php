...
<header class="main-header">
    ...
    <a href="<?php echo e(url(config('crudbooster.ADMIN_PATH'))); ?>" title='<?php echo e(Session::get('appname')); ?>'
        class="logo"><?php echo e(CRUDBooster::getSetting('appname')); ?></a>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                <?php if(CRUDBooster::getSetting('activate_notifications') == 'true'): ?>
                    <li class="dropdown notifications-menu">
                        ...
                        <ul id='list_notifications' class="dropdown-menu">
                            ...
                            <li class="footer"><a
                                    href="<?php echo e(route('NotificationsControllerGetIndex')); ?>"><?php echo e(cbLang('text_view_all_notification')); ?></a>
                            </li>
                        </ul>
                    </li>
                <?php endif; ?>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="<?php echo e(CRUDBooster::myPhoto() ?: asset('vendor/crudbooster/avatar.jpg')); ?>"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-<?php echo e(cbLang('left')); ?>">
                                <a href="<?php echo e(route('AdminCmsUsersControllerGetProfile')); ?>"
                                    class="btn btn-default btn-flat"><i class='fa fa-user'></i>
                                    <?php echo e(cbLang('label_button_profile')); ?></a>
                            </div>
                            <div class="pull-<?php echo e(cbLang('right')); ?>">
                                <a title='Lock Screen' href="<?php echo e(route('getLockScreen')); ?>"
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    title="<?php echo e(cbLang('button_logout')); ?>" class="btn btn-danger btn-flat"><i
        ...
        <?php if(get_setting('tow_languages_active') == 'yes'): ?>
            <?php if(App::getlocale() == 'ar'): ?>
                <div class="navbar-custom-menu" style="padding: 15px">
                    <a style="<?php echo e(App::getlocale() == 'en' ? '' : 'color:#fff;'); ?>"
                        href="<?php echo e(Route('cb.switch_language', ['locale' => 'en'])); ?>">English</a>
                </div>
            <?php else: ?>
                <div class="navbar-custom-menu" style="margin-top: 15px">
                    <a style="<?php echo e(App::getlocale() == 'en' ? 'color:#fff;' : ''); ?>"
                        href="<?php echo e(Route('cb.switch_language', ['locale' => 'ar'])); ?>">العربية</a>
                </div>
            <?php endif; ?>
        <?php endif; ?>
    </nav>
</header>
<?php /**PATH C:\xampp\htdocs\BMSK\BMSK\vendor\voila_cms\crudbooster\src/views/header.blade.php ENDPATH**/ ?>
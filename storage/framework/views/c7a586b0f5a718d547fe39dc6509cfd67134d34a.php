...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('vendor/filemanager/img/ico/favicon.ico')); ?>">
    <!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
    <link rel="stylesheet" href="<?php echo e(asset('vendor/filemanager/css/jquery.fileupload.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('vendor/filemanager/css/jquery.fileupload-ui.css')); ?>">
    <!-- CSS adjustments for browsers with JavaScript disabled -->
    <noscript>
        <link rel="stylesheet" href="<?php echo e(asset('vendor/filemanager/css/jquery.fileupload-noscript.css')); ?>">
    </noscript>
    <noscript>
        <link rel="stylesheet" href="<?php echo e(asset('vendor/filemanager/css/jquery.fileupload-ui-noscript.css')); ?>">
    </noscript>
    <link rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/jplayer/2.7.1/skin/blue.monday/jplayer.blue.monday.min.css" />
    <link rel="stylesheet" href="https://uicdn.toast.com/tui-image-editor/latest/tui-image-editor.css">
    <link href="<?php echo e(asset('vendor/filemanager/css/style.css')); ?>" rel="stylesheet" type="text/css" />

    <script src="https://code.jquery.com/jquery-1.12.4.min.js"
        integrity="sha256-ZosEbRLbNQzLpnKIkEdrPv7lOy9C27hHQ+Xp8a4MxAQ=" crossorigin="anonymous"></script>
    <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.min.js"
        integrity="sha256-VazP97ZCwtekAsvgPBSUwPFKdrwD3unUfSGVYrahUqU=" crossorigin="anonymous"></script>
    <script src="<?php echo e(asset('vendor/filemanager/js/plugins.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('vendor/filemanager/js/modernizr.custom.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('vendor/filemanager/js/include.js')); ?>"></script>
</head>
...
<body>
    ...
    <script src="<?php echo e(asset('vendor/filemanager/js/jquery.iframe-transport.js')); ?>"></script>
    <!-- The basic File Upload plugin -->
    <script src="<?php echo e(asset('vendor/filemanager/js/jquery.fileupload.js')); ?>"></script>
    <!-- The File Upload processing plugin -->
    <script src="<?php echo e(asset('vendor/filemanager/js/jquery.fileupload-process.js')); ?>"></script>
    <!-- The File Upload image preview & resize plugin -->
    <script src="<?php echo e(asset('vendor/filemanager/js/jquery.fileupload-image.js')); ?>"></script>
    <!-- The File Upload audio preview plugin -->
    <script src="<?php echo e(asset('vendor/filemanager/js/jquery.fileupload-audio.js')); ?>"></script>
    <!-- The File Upload video preview plugin -->
    <script src="<?php echo e(asset('vendor/filemanager/js/jquery.fileupload-video.js')); ?>"></script>
    <!-- The File Upload validation plugin -->
    <script src="<?php echo e(asset('vendor/filemanager/js/jquery.fileupload-validate.js')); ?>"></script>
    <!-- The File Upload user interface plugin -->
    <script src="<?php echo e(asset('vendor/filemanager/js/jquery.fileupload-ui.js')); ?>"></script>
                            ...
                            <div class="row-fluid">
                                <div class="span4 half">
                                    ...
                                    <button class="tip btn upload-btn"
                                        title="<?php echo e(cbLang('filemanager.Upload_file')); ?>"><i
...
?>
                ...
                <li class="pull-right"><a id="refresh" class="btn-small"
                        href="<?php echo e(Route('dialog')); ?>?<?php echo $get_params . $subdir . '&' . uniqid(); ?>"><i class="icon-refresh"></i></a></li>
        ...
        ?>
                    <li data-name="<?php echo $file; ?>"
                        ...
                        ?><figure data-name="<?php echo $file; ?>"
                            ...
                            <?php }?>
                            <a class="folder-link" href="<?php echo e(Route('dialog')); ?>?<?php echo $get_params . rawurlencode($src) . '&' . ($callback ? 'callback=' . $callback . '&' : '') . uniqid(); ?>">
                            ...
                            <div class="box">
                                <h4 class="<?php if ($config['ellipsis_title_after_first_row']) {
                                    echo 'ellipsis';
                                        ...
                                        href="<?php echo e(Route('dialog')); ?>?<?php echo $get_params . rawurlencode($src) . '&' . uniqid(); ?>"><?php echo $file; ?></a>
                                </h4>
                            </div>
            ...
            ?>
                    <li class="ff-item-type-<?php echo $class_ext; ?> file <?php if (!$config['multiple_selection']) {?>no-selector<?php }?>"
                        ...
                        <figure data-name="<?php echo $file; ?>" data-path="<?php echo $rfm_subfolder . $subdir . $file; ?>"
                            ...
                            <figcaption>
                                <form action="<?php echo e(route('filemanager.download')); ?>" method="post"
    ...
    <div id="loading_container" style="display:none;">
        ...
        <img id="loading_animation" src="<?php echo e(asset('vendor/filemanager/img/storing_animation.gif')); ?>" alt="loading"
        ...
        if (image_editor) {
            ...
            imageEditor.loadImageFromURL = (function() {
                ...
                return function() {
                    ...
                    // arguments[0] = "<?php echo e(URL::asset('')); ?>" + arguments[0];
            ...
            function saveTUI() {
                ...
                $.ajax({
                    ...
                    data: {
                        url: newURL,
                        path: '<?php echo e(URL::asset('')); ?>' + $('#sub_folder').val() + $('#fldr_value').val(),
...
<?php /**PATH C:\xampp\htdocs\BMSK\BMSK\vendor\voila_cms\crudbooster\src/views/filamanager/filemanager.blade.php ENDPATH**/ ?>
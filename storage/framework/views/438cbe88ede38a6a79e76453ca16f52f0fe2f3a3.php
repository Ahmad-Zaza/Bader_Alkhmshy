<?php $__env->startSection('content'); ?>
    ...
    <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a href="<?php echo e(Route('ModulsControllerGetStep3') . '/' . $id); ?>"><i
                    class='fa fa-plus-square-o'></i> <?php echo e(cbLang('Step 3')); ?> - <?php echo e(cbLang('Form Display')); ?></a></li>
        <li role="presentation"><a href="<?php echo e(Route('ModulsControllerGetStep4') . '/' . $id); ?>"><i class='fa fa-wrench'></i>
                                    ...
                                    if (val instanceof Object) {
                                        ...
                                        if (data.type == 'filemanager') {
                                            form_group_html +=
                                                ...
                                                "][" +
                                                key + "]'>" +
                                                "<option value='' <?php echo e($value == '' ? 'selected=true' : 'selected=false'); ?> >Please Choose File or Image</option>" +
                                                "<option value='file' <?php echo e($value == 'file' ? 'selected=true' : 'selected=false'); ?> >File</option>" +
                                                "<option value='image' <?php echo e($value == 'image' ? 'selected=true' : 'selected=false'); ?> >Image</option>" +
                                                "</select>" +
                                                "</div>";
                                        } else {
                                            form_group_html +=
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class='fa fa-cog'></i> <?php echo e(cbLang('Options')); ?></h4>
                </div>
                <div class="modal-body">
                    <p>One fine body&hellip;</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(cbLang('Close')); ?></button>
                    <button type="button" class="btn-save-option btn btn-primary"><?php echo e(cbLang('Save changes')); ?></button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo e(cbLang('Form Display')); ?></h3>
        </div>
        <div class="box-body">
            <form method="post" autocomplete="off" action="<?php echo e(Route('ModulsControllerPostStep4')); ?>">
                ...
                <table class='table-form table table-striped'>
                    <thead>
                        <tr>
                            <th><?php echo e(cbLang('Label')); ?></th>
                            <th><?php echo e(cbLang('Name')); ?></th>
                            <th><?php echo e(cbLang('Type')); ?></th>
                            <th><?php echo e(cbLang('Validation')); ?></th>
                            <th width="90px"><?php echo e(cbLang('Width')); ?></th>
                            <th width="100px"><?php echo e(cbLang('Options')); ?></th>
                            <th width="180px"><?php echo e(cbLang('Action')); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $index = 0; ?>
                        <?php $__currentLoopData = $cb_form; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $form): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><input type='text' value='<?php echo e($form['validation']); ?>' class='form-control validation'
                                ...
                                <td>
                                    <select class='form-control width' name='width[]'>
                                        <?php for($i = 10; $i >= 1; $i--): ?>
                                            <option <?php echo e($form['width'] == "col-sm-$i" ? 'selected' : ''); ?>

                                                value='col-sm-<?php echo e($i); ?>'><?php echo e($i); ?></option>
                                        <?php endfor; ?>
                                    </select>
                                </td>
                                <td>
                                    <a class='btn btn-primary btn-options' href='javascript:;'><i class='fa fa-cog'></i>
                                        <?php echo e(cbLang('Options')); ?></a>
                                    ...
                                    ?>
                                        <div class="form-group">
                                            ...
                                            <?php $__currentLoopData = $val->enum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <input type="radio"
                                                    name="option[<?php echo e($index); ?>][<?php echo e($key); ?>]"
                                                    <?php echo e($enum == $value ? 'checked' : ''); ?> value="<?php echo e($enum); ?>">
                                                <?php echo e($enum); ?>
                                        ...
                                        <div class="form-group">
                                            <label><?php echo e($key); ?></label>
                                            <input type="text" name="option[<?php echo e($index); ?>][<?php echo e($key); ?>]"
                                                placeholder="<?php echo e($val->placeholder); ?>" value="<?php echo e($value); ?>"
                                                class="form-control">
                                        </div>
                                        <?php endif;?>
                                        <?php else:?>
                                        ...
                                        <script>
                                            fileManagerValue["<?php echo e($index); ?>"] = "<?php echo e($value); ?>";
                                        </script>

                                        <label><?php echo e($key); ?></label>
                                        <div class="form-group">
                                            <select name="option[<?php echo e($index); ?>][<?php echo e($key); ?>]"
                                                class="form-control filemanager-form-control <?php echo e($index); ?> required">
                                                <option value=""
                                                    <?php echo e($value == '' ? 'selected="true"' : 'selected="false"'); ?>>Please
                                                    choose File or Image</option>
                                                <option value="file"
                                                    <?php echo e($value == 'file' ? 'selected="true"' : 'selected="false"'); ?>>File
                                                </option>
                                                <option value="image"
                                                    <?php echo e($value == 'image' ? 'selected="true"' : 'selected="false"'); ?>>Image
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                name="option[<?php echo e($index); ?>][<?php echo e($key); ?>]"
                                                placeholder="<?php echo e($val); ?>" value="<?php echo e($value); ?>"
                                                class="form-control">
                                        </div>
                                        <?php endif;?>
                                    ...
                                    ?>
                                        <div class="form-group">
                                            ...
                                            <?php if(is_object($val) && property_exists($val, 'type') && $val->type == 'textarea'): ?>
                                                <textarea type="text" name="option[<?php echo e($index); ?>][<?php echo e($key); ?>]"
                                                    placeholder="<?php echo e($val->placeholder); ?>" class="form-control"><?php echo e($value); ?></textarea>
                                            <?php else: ?>
                                                <input type="text"
                                                    name="option[<?php echo e($index); ?>][<?php echo e($key); ?>]"
                                                    placeholder="<?php echo e($val); ?>" value="<?php echo e($value); ?>"
                        ...
                        <tr id='tr-sample' style="display: none">
                            ...
                            <td>
                                <select class='form-control width' name='width[]'>
                                    <?php for($i = 10; $i >= 1; $i--): ?>
                                        <option <?php echo e($i == 9 ? 'selected' : ''); ?> value='col-sm-<?php echo e($i); ?>'>
                                            <?php echo e($i); ?></option>
                                    <?php endfor; ?>
                                </select>
                            </td>
        ...
        <div class="box-footer">
            <div align="right">
                <button type="button" onclick="location.href='<?php echo e(CRUDBooster::mainpath('step2') . '/' . $id); ?>'"
                    class="btn btn-default">&laquo; Back</button>
                <input type="submit" class="btn btn-primary" value="<?php echo e(cbLang('Step 4')); ?> &raquo;">
            </div>
        </div>
        </form>
    </div>
...
<?php echo $__env->make('crudbooster::admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BMSK\BMSK\vendor\voila_cms\crudbooster\src/views/module_generator/step3.blade.php ENDPATH**/ ?>
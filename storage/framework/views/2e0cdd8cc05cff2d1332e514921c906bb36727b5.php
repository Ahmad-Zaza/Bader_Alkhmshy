<?php $__env->startSection('content'); ?>
    ...
    <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a href="<?php echo e(Route('ModulsControllerGetStep2') . '/' . $id); ?>"><i
                    class='fa fa-table'></i> <?php echo e(cbLang('Step 2')); ?> - <?php echo e(cbLang('Table Display')); ?></a></li>
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo e(cbLang('Table Display')); ?></h3>
        </div>
        <div class="box-body">
            ...
            <form method="post" action="<?php echo e(Route('ModulsControllerPostStep3')); ?>">
                ...
                <table class="table-display table table-striped">
                    <thead>
                        <tr>
                            <th><?php echo e(cbLang('Column')); ?></th>
                            <th><?php echo e(cbLang('Name')); ?></th>
                            <th colspan='2'><?php echo e(cbLang('Join') . '(' . cbLang('Optional') . ')'); ?> </th>
                            <th>CallbackPHP</th>
                            <th width="90px"><?php echo e(cbLang('Width')); ?> (px)</th>
                            <th width='75px'><?php echo e(cbLang('Image')); ?></th>
                            <th width='75px'><?php echo e(cbLang('Download')); ?></th>
                            <th width='75px'><?php echo e(cbLang('Switch')); ?></th>
                            <th width='85px'><?php echo e(cbLang('Str Limit')); ?></th>
                    ...
                    <tbody>
                        <?php if($cb_col): ?>
                            <?php $__currentLoopData = $cb_col; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><input value='<?php echo e($c['label']); ?>' type='text' name='column[]'
                                    ...
                                    <td><input value='<?php echo e($c['name']); ?>' type='text' name='name[]'
                                    ...
                                    <td><input value='<?php echo e(@explode(',', $c['join'])[0]); ?>' type='text'
                                            ...
                                            value='' /></td>
                                    <td><input value='<?php echo e(@explode(',', $c['join'])[1]); ?>' type='text'
                                    ...
                                    <td><input type='text' name='callbackphp[]' class='form-control callbackphp notfocus'
                                            value='<?php echo e($c['callback_php']); ?>' placeholder="Optional" /></td>
                                    <td><input value='<?php echo e($c['width'] ?: 0); ?>' type='number' name='width[]'
                                    ...
                                    <td>
                                        <select class='form-control is_switch' name='is_switch[]'>
                                            <option <?php echo e(!$c['switch'] ? 'selected' : ''); ?> value='0'>N</option>
                                            <option <?php echo e($c['switch'] ? 'selected' : ''); ?> value='1'>Y</option>
                                        </select>
                                    </td>
                                    <td>
                                        <input type='number' name='str_limit[]' class='form-control callbackphp notfocus'
                                            value='<?php echo e($c['str_limit'] ?: 0); ?>' placeholder="" />
                                    </td>
                                    <td>
        ...
        <div class="box-footer">
            <div align="right">
                <button type="button" onclick="location.href='<?php echo e(CRUDBooster::mainpath('step1') . '/' . $id); ?>'"
...
<?php echo $__env->make('crudbooster::admin_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BMSK\BMSK\vendor\voila_cms\crudbooster\src/views/module_generator/step2.blade.php ENDPATH**/ ?>